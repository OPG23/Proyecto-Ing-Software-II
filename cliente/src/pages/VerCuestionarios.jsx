  ...
  return (
    <div className="max-w-3xl mx-auto mt-8 bg-[rgba(231,231,231,0.9)] rounded-lg shadow-lg p-6 border-2">
      ...
      {cuestionarios.length === 0 && (
        <p className="text-center">No hay cuestionarios disponibles.</p>
      )}
      ...
      <div className="w-full flex items-center justify-center">
        <Link
          to="/"
          className="bg-[#8b8a8a] flex items-center justify-center w-25 rounded-md px-4 py-1 text-sm sm:text-xl sm:px-5 sm:py-1 border-1 cursor-pointer"
        >
          Atrás
        </Link>
      </div>
