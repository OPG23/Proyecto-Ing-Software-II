            ...
            <div className="bg-[rgba(231,231,231,0.9)] max-w-md w-90 pt-5 rounded-4xl border-2 border-solid">
                ...
                <ul className="mx-4 ">
                    {cargando ? (
                        ...
                        tareas.map((tarea) => (
                            <li key={tarea._id} className="rounded-2xl border-2 border-gray-400 text-center my-4 py-1 space-y-2">
                                <h2 className="text-2xl font-bold text-center">{tarea.titulo}</h2>
